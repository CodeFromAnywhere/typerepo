...
exports.getImportsExports = exports.CONCURRENTLY_INDEXED_FILES_AMOUNT = void 0;
...
exports.CONCURRENTLY_INDEXED_FILES_AMOUNT = 10;
/**
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, js_util_1.mapMany)(sourceFiles, function (sourceFile) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                ...
                                if (!absoluteFilePath)
                                    return [2 /*return*/];
                                operationRelativeTypescriptFilePath = (0, fs_util_js_1.makeRelative)(absoluteFilePath, operationBasePath);
                                exportSymbols = sourceFile.getExportSymbols();
                                tsExports = exportSymbols.map(function (symbol) {
                                    var name = symbol.getName();
                                    var typeSpecifier = { type: "value" };
                        ...
                        }); }, exports.CONCURRENTLY_INDEXED_FILES_AMOUNT)];
                case 3:
                    allTsExports = (_b.sent())
                        .filter(js_util_1.notEmpty)
                        .flat();
                    return [4 /*yield*/, (0, one_by_one_1.oneByOne)(sourceFiles, function (sourceFile) { return __awaiter(void 0, void 0, void 0, function () {
                            var absoluteFilePath, operationRelativeTypescriptFilePath, importDeclarations, importInfos, tsImports, e_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        absoluteFilePath = sourceFile.getFilePath();
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, (0, one_by_one_1.oneByOne)(importDeclarations, function (importDeclaration) { return __awaiter(void 0, void 0, void 0, function () {
                                                var module_1, importSpecifiers, namedImports, isModuleResolved, e_2;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            _a.trys.push([0, 2, , 3]);
                                                            module_1 = String(importDeclaration.getModuleSpecifier().getLiteralText());
                                                            importSpecifiers = importDeclaration.getNamedImports();
                                                            return [4 /*yield*/, (0, one_by_one_1.oneByOne)(importSpecifiers, function (x) { return __awaiter(void 0, void 0, void 0, function () {
                                                                    var name, isOperation, typeSpecifier, namedImport;
                                                                    return __generator(this, function (_a) {
                                                                        name = x.getName();
                                                                        isOperation = allOperations.includes(module_1);
                                                                        typeSpecifier = isOperation
                                                                        ...
                                                                        return [2 /*return*/, namedImport];
                                                                    });
                                                                }); })];
                                                        case 1:
                                                            namedImports = _a.sent();
                                                            isModuleResolved = !!importDeclaration.getModuleSpecifierSourceFile();
                                                            return [2 /*return*/, { namedImports: namedImports, module: module_1, isModuleResolved: isModuleResolved }];
                                                        case 2:
                                                            e_2 = _a.sent();
                                    ...
                                    case 2:
                                        importInfos = (_a.sent()).filter(js_util_1.notEmpty);
                                        tsImports = importInfos
                                            ...
                                            var reactModules = ["react", "react-dom", "react-native", "expo"];
