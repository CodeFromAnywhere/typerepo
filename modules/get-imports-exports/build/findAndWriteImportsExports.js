...
manualProjectRoot) { return __awaiter(void 0, void 0, void 0, function () {
    var operationName, sourceFiles, problem, importsAndExports, problem, exports, imports, packageJsons;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                ...
                return [4 /*yield*/, database_1.db.get("PackageJson", { manualProjectRoot: manualProjectRoot })];
            case 7:
                packageJsons = _a.sent();
                return [4 /*yield*/, database_1.db.update("PackageJson", 
                    ...
                    function (x) { return x.name === operationName; }, function (packageJson) {
                        var _a = (0, calculatePackageJsonDependencies_1.calculatePackageJsonDependencies)(packageJson.dependencies, imports, packageJsons, operationName), newDependencies = _a.newDependencies, hasGeneratedDependencies = _a.hasGeneratedDependencies;
                        var newSensibleObject = packageJson.sensible
                            ? __assign(__assign({}, packageJson.sensible), { hasGeneratedDependencies: hasGeneratedDependencies }) : { hasGeneratedDependencies: hasGeneratedDependencies };
                        return __assign(__assign({}, packageJson), { sensible: newSensibleObject, dependencies: newDependencies });
