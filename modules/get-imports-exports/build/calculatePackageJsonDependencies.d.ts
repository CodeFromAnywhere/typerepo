 ...
 */
export declare const calculatePackageJsonDependencies: (dependencies: PackageInfoObject | undefined, imports: Creation<TsImport>[], packageJsons: PackageJson[]) => PackageInfoObject;
