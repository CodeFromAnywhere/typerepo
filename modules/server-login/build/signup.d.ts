 ...
 */
export declare const signup: (deviceId: string, personData: Pick<Person, "authorizations" | "credits" | "dataEntries" | "interestSlugs" | "media" | "name" | "slug" | "pictureImage" | "groupSlugs" | "requiredAuthenticationMethods" | "amountAuthenticationMethodsRequired">) => Promise<{
