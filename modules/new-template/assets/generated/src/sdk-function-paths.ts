export const sdkFunctionPaths = {
  "BreadCrumbs": "/operations/tools/writer/breadcrumbs/db/ts-functions/bread-crumbs.json",
  ...
  "getActivePage": "/operations/tools/writer/file-tabs/db/ts-functions/get-active-page.json",
  ...
  "MarkdownParsePresentation": "/operations/tools/writer/writer-input/db/ts-functions/markdown-parse-presentation.json",
  ...
  "renderBreadCrumbs": "/operations/tools/writer/breadcrumbs/db/ts-functions/render-bread-crumbs.json",
  "renderIcon": "/operations/tools/writer/file-tabs/db/ts-functions/render-icon.json",
  ...
  "makeApi": "/operations/tools/deployment/deprecated/sensible/sensible-core/db/ts-functions/make-api.json",
  ...
  "getContext": "/operations/tools/writer/writer-input/db/ts-functions/get-context.json",
  ...
  "getFunctionsInfo": "/operations/tools/parsing/file-conversion/md/markdown-parsings/db/ts-functions/get-functions-info.json",
  ...
  "createFolder": "/operations/tools/parsing/file-conversion/md/markdown-translator/db/ts-functions/create-folder.json",
  "getAllMarkdownFiles": "/operations/tools/parsing/file-conversion/md/markdown-translator/db/ts-functions/get-all-markdown-files.json",
  "getFileInfo": "/operations/tools/parsing/file-conversion/md/markdown-translator/db/ts-functions/get-file-info.json",
  "getTranslatedWord": "/operations/tools/parsing/file-conversion/md/markdown-translator/db/ts-functions/get-translated-word.json",
  "markdownStoreAndRecord": "/operations/tools/parsing/file-conversion/md/markdown-translator/db/ts-functions/markdown-store-and-record.json",
  "parseMarkdownWordByWord": "/operations/tools/parsing/file-conversion/md/markdown-translator/db/ts-functions/parse-markdown-word-by-word.json",
  "recordMdFile": "/operations/tools/parsing/file-conversion/md/markdown-translator/db/ts-functions/record-md-file.json",
  "startMarkdownTranslator": "/operations/tools/parsing/file-conversion/md/markdown-translator/db/ts-functions/start-markdown-translator.json",
  "startTranslation": "/operations/tools/parsing/file-conversion/md/markdown-translator/db/ts-functions/start-translation.json",
  "translatedArrayToKeyValue": "/operations/tools/parsing/file-conversion/md/markdown-translator/db/ts-functions/translated-array-to-key-value.json",
  "watchMdFile": "/operations/tools/parsing/file-conversion/md/markdown-translator/db/ts-functions/watch-md-file.json",
  ...
  "addSocialMediaCredential": "/operations/tools/social-media/social-media-controller/db/ts-functions/add-social-media-credential.json",
  "contentParser": "/operations/tools/social-media/social-media-controller/db/ts-functions/content-parser.json",
  "devtoCotentAnalyzer": "/operations/tools/social-media/social-media-controller/db/ts-functions/devto-cotent-analyzer.json",
  "facebookContentAnalyzer": "/operations/tools/social-media/social-media-controller/db/ts-functions/facebook-content-analyzer.json",
  "facebookContentParser": "/operations/tools/social-media/social-media-controller/db/ts-functions/facebook-content-parser.json",
  "getSocialMediaCredentials": "/operations/tools/social-media/social-media-controller/db/ts-functions/get-social-media-credentials.json",
  "mediumCotentAnalyzer": "/operations/tools/social-media/social-media-controller/db/ts-functions/medium-cotent-analyzer.json",
  "redditContentAnalyzer": "/operations/tools/social-media/social-media-controller/db/ts-functions/reddit-content-analyzer.json",
  "socialMediaPostPlanner": "/operations/tools/social-media/social-media-controller/db/ts-functions/social-media-post-planner.json",
  "startSocialMediaController": "/operations/tools/social-media/social-media-controller/db/ts-functions/start-social-media-controller.json",
  "twitterContentAnalyzer": "/operations/tools/social-media/social-media-controller/db/ts-functions/twitter-content-analyzer.json",
  ...
  "getFileType": "/operations/tools/writer/file-icons/db/ts-functions/get-file-type.json",
  "MatchingText": "/operations/tools/writer/file-search/db/ts-functions/matching-text.json",
  "PathSearchResults": "/operations/tools/writer/file-search/db/ts-functions/path-search-results.json",
  "FileTabs": "/operations/tools/writer/file-tabs/db/ts-functions/file-tabs.json",
  "getOpenPageUrl": "/operations/tools/writer/file-tabs/db/ts-functions/get-open-page-url.json",
  "FileWriter": "/operations/tools/writer/file-writer/db/ts-functions/file-writer.json",
  "OpenFileWriterPages": "/operations/tools/writer/file-writer/db/ts-functions/open-file-writer-pages.json",
  "isAltB": "/operations/tools/writer/hotkeys/db/ts-functions/is-alt-b.json",
  "isAltN": "/operations/tools/writer/hotkeys/db/ts-functions/is-alt-n.json",
  "isAltO": "/operations/tools/writer/hotkeys/db/ts-functions/is-alt-o.json",
  "isAltW": "/operations/tools/writer/hotkeys/db/ts-functions/is-alt-w.json",
  "isCtrlBacktick": "/operations/tools/writer/hotkeys/db/ts-functions/is-ctrl-backtick.json",
  "isCtrlP": "/operations/tools/writer/hotkeys/db/ts-functions/is-ctrl-p.json",
  "isCtrlS": "/operations/tools/writer/hotkeys/db/ts-functions/is-ctrl-s.json",
  "isCtrlSpace": "/operations/tools/writer/hotkeys/db/ts-functions/is-ctrl-space.json",
  "useHotkey": "/operations/tools/writer/hotkeys/db/ts-functions/use-hotkey.json",
  "useHotkeys": "/operations/tools/writer/hotkeys/db/ts-functions/use-hotkeys.json",
  "getFullPath": "/operations/tools/writer/next-paths/db/ts-functions/get-full-path.json",
  "getLastPathsChunk": "/operations/tools/writer/next-paths/db/ts-functions/get-last-paths-chunk.json",
  "usePath": "/operations/tools/writer/next-paths/db/ts-functions/use-path.json",
  "getFileContents": "/operations/tools/writer/writer-functions/db/ts-functions/get-file-contents.json",
  "getFrontmatterSchema": "/operations/tools/writer/writer-functions/db/ts-functions/get-frontmatter-schema.json",
  "moveFile": "/operations/tools/writer/writer-functions/db/ts-functions/move-file.json",
  "newFile": "/operations/tools/writer/writer-functions/db/ts-functions/new-file.json",
  "newFolder": "/operations/tools/writer/writer-functions/db/ts-functions/new-folder.json",
  "renameFilename": "/operations/tools/writer/writer-functions/db/ts-functions/rename-filename.json",
  "saveFileContents": "/operations/tools/writer/writer-functions/db/ts-functions/save-file-contents.json",
  "Completion": "/operations/tools/writer/writer-input/db/ts-functions/completion.json",
  "ContentEditableDivInput": "/operations/tools/writer/writer-input/db/ts-functions/content-editable-div-input.json",
  "ContextTextArea": "/operations/tools/writer/writer-input/db/ts-functions/context-text-area.json",
  "DivContentEditable": "/operations/tools/writer/writer-input/db/ts-functions/div-content-editable.json",
  "editSubtextSubwordConfig": "/operations/tools/writer/writer-input/db/ts-functions/edit-subtext-subword-config.json",
  "FrontmatterForm": "/operations/tools/writer/writer-input/db/ts-functions/frontmatter-form.json",
  "getSubtext": "/operations/tools/writer/writer-input/db/ts-functions/get-subtext.json",
  "getTextSegments": "/operations/tools/writer/writer-input/db/ts-functions/get-text-segments.json",
  "getWriterTypeFromContent": "/operations/tools/writer/writer-input/db/ts-functions/get-writer-type-from-content.json",
  "isAugmentedWordMatch": "/operations/tools/writer/writer-input/db/ts-functions/is-augmented-word-match.json",
  "isTypescript": "/operations/tools/writer/writer-input/db/ts-functions/is-typescript.json",
  "MarkdownCompletions": "/operations/tools/writer/writer-input/db/ts-functions/markdown-completions.json",
  "MarkdownView": "/operations/tools/writer/writer-input/db/ts-functions/markdown-view.json",
  "MarkedParagraph": "/operations/tools/writer/writer-input/db/ts-functions/marked-paragraph.json",
  "MarkedText": "/operations/tools/writer/writer-input/db/ts-functions/marked-text.json",
  "MarkedToken": "/operations/tools/writer/writer-input/db/ts-functions/marked-token.json",
  "omitSpecialCharactersFromStart": "/operations/tools/writer/writer-input/db/ts-functions/omit-special-characters-from-start.json",
  "parseTextContentToHtmlString": "/operations/tools/writer/writer-input/db/ts-functions/parse-text-content-to-html-string.json",
  "SmartContentEditableDivInput": "/operations/tools/writer/writer-input/db/ts-functions/smart-content-editable-div-input.json",
  "SpannedSentence": "/operations/tools/writer/writer-input/db/ts-functions/spanned-sentence.json",
  "SubtextContainer": "/operations/tools/writer/writer-input/db/ts-functions/subtext-container.json",
  "Subword": "/operations/tools/writer/writer-input/db/ts-functions/subword.json",
  "testAllContentEditableRenderComponents": "/operations/tools/writer/writer-input/db/ts-functions/test-all-content-editable-render-components.json",
  "testContentEditableRenderComponent": "/operations/tools/writer/writer-input/db/ts-functions/test-content-editable-render-component.json",
  "TitleContainer": "/operations/tools/writer/writer-input/db/ts-functions/title-container.json",
  "trimAround": "/operations/tools/writer/writer-input/db/ts-functions/trim-around.json",
  "trimLeft": "/operations/tools/writer/writer-input/db/ts-functions/trim-left.json",
  "TypescriptCompletions": "/operations/tools/writer/writer-input/db/ts-functions/typescript-completions.json",
  "WriterConfigForm": "/operations/tools/writer/writer-input/db/ts-functions/writer-config-form.json",
  "WriterInput": "/operations/tools/writer/writer-input/db/ts-functions/writer-input.json",
