 ...
 */
var removeNumberPrefix=function(e){return e.split(".").reduce((function(e,r,i,o){if(isNaN(Number(r)))return o.slice(i).join(".")}),void 0)||"untitled"};exports.removeNumberPrefix=removeNumberPrefix;
