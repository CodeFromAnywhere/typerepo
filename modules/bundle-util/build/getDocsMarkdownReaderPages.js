        ...
        switch (_b.label) {
            ...
            case 2:
                ...
                operationPages = (0, get_path_1.isSensibleProject)(projectRoot)
                    ? __spreadArray(__spreadArray(__spreadArray([], operationPagesPerType.packages, true), operationPagesPerType.apps, true), operationPagesPerType.modules, true) : __spreadArray(__spreadArray([], operationPagesPerType["operations/tools"], true), operationPagesPerType["operations/bundles"], true);
