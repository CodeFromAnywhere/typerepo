 ...
 */
var makeTsComment = function (_a) {
    var commentRange = _a.commentRange, rawStatement = _a.rawStatement, statementName = _a.statementName, fileContent = _a.fileContent, operationRelativeTypescriptFilePath = _a.operationRelativeTypescriptFilePath;
    ...
    var _b = isSingleLineComment
        ? { raw: strippedComment, parameters: {} }
        : (0, markdown_parse_js_1.parseFrontmatterMarkdownString)(strippedComment), parameters = _b.parameters, comment = _b.raw;
