...
var generateSchema = function (filePath, morphInterfaceInfo, namedAbsoluteImportNames) { return __awaiter(void 0, void 0, void 0, function () {
    var problems, operationBasePath, operationRelativePath, operationFolderName, tsConfigPath, tsConfigExists, problem, config, _a, schema, error, problem_1, interfacePromises, interfaces;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                operationRelativePath = (0, fs_util_js_1.makeRelative)(filePath, operationBasePath);
                ...
                return [4 /*yield*/, database_1.db.update("Operation", function (item) { return item.name === operationFolderName; }, function (old) {
            ...
            case 2:
                ...
                problem_1 = "No schema/definitions found for ".concat(filePath, ". Error: ").concat(error);
                (0, log_1.log)(problem_1, { type: "warning" });
                return [4 /*yield*/, database_1.db.update("Operation", function (item) { return item.name === operationFolderName; }, function (old) {
                        return (0, js_util_1.mergeNestedObject)(old, {
                            operation: {
                                buildResultIndexed: { indexInteracesErrors: [problem_1] },
                            },
                        });
                    }, { operationName: operationFolderName })];
            case 3:
