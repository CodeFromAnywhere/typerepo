    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                (0, log_1.log)(problem, { type: "debug" });
            ...
            case 4:
                interfacePromises = Object.keys(schema.definitions).map(function (typeName) {
                    ...
                    if (tsMorphFoundTypeAlso || isImportedType) {
                    ...
                    (0, log_1.log)("Skipping type ".concat(typeName, ": ").concat(String(tsMorphFoundTypeAlso), ", ").concat(String(isImportedType)), { type: "debug" });
