...
var indexTypescriptFile = function (project, file, projectRoot) { return __awaiter(void 0, void 0, void 0, function () {
    var problems, filePath, operationName, operationRelativeTypescriptFilePath, fileContent, sourceFile, problem, newTsInterfaces, allTsInterfaces, allWithNewTsInterfaces, tsLintWarnings, mainComment, pathMetaData, _a, tsFunctions, tsVariables, topLevelComments, functionComments, interfaceComments, variableComments, tsComments;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, database_1.db.update("Operation", function (item) { return item.name === operationName; }, function (old) {
            ...
            case 5:
                allTsInterfaces = _b.sent();
                allWithNewTsInterfaces = __spreadArray(__spreadArray([], newTsInterfaces, true), allTsInterfaces, true).filter((0, js_util_1.onlyUnique2)(function (a, b) { return a.name === b.name; }));
                tsLintWarnings = [];
                mainComment = undefined;
                return [4 /*yield*/, (0, path_util_1.calculatePathMetaData)(filePath)];
            case 6:
                pathMetaData = _b.sent();
                return [4 /*yield*/, (0, getTsStatements_1.getTsStatements)(sourceFile, allWithNewTsInterfaces, operationRelativeTypescriptFilePath, fileContent)];
            case 7:
                ...
                functionComments = tsFunctions
                    ...
                    .flat();
                interfaceComments = newTsInterfaces
                    .map(function (f) { return f.commentsInside; })
                    .flat();
