 ...
 */
backendAsset) { return __awaiter(void 0, void 0, void 0, function () {
    var projectRoot, realBackendASset, alt, name, relativePath, temporaryDestination, projectRelativeReferencingFilePath, modelName, absoluteReferencingFilePath, slugifiedName, absoluteTemporaryDestination, oldAssetStoragePath, extension, storageLocationInfo, finalAssetStoragePath, finalAvailableStoragePath, newRelativePath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                realBackendASset = backendAsset ? (0, js_util_1.takeFirst)(backendAsset) : undefined;
                if (!realBackendASset) {
                    console.log("processAsset: No real backend asset");
                    return [2 /*return*/];
                }
                alt = realBackendASset.alt, name = realBackendASset.name, relativePath = realBackendASset.relativePath, temporaryDestination = realBackendASset.temporaryDestination, projectRelativeReferencingFilePath = realBackendASset.projectRelativeReferencingFilePath, modelName = realBackendASset.modelName;
                if (!projectRelativeReferencingFilePath) {
                    (0, log_1.log)("processAsset: projectRelativeReferencingFilePath wasn't provided, not processing asset", { type: "warning" });
                ...
                if (!relativePath && !temporaryDestination) {
                    (0, log_1.log)("processAsset: no relativePath, no temporaryDestination", {
                        type: "warning",
                    });
                ...
                if (absoluteTemporaryDestination) {
                    if (!fs_util_1.fs.existsSync(absoluteTemporaryDestination)) {
                        (0, log_1.log)("processAsset: absoluteTemporaryDestination does not exist", {
                            type: "warning",
                        });
                        return [2 /*return*/, undefined];
                    }
                ...
                if (oldAssetStoragePath && !temporaryDestination) {
                    if (!fs_util_1.fs.existsSync(oldAssetStoragePath)) {
                        (0, log_1.log)("processAsset: oldAssetStoragePath does not exist (".concat(oldAssetStoragePath, ")"), {
                            type: "warning",
                        });
                        return [2 /*return*/, undefined];
                    }
                ...
                if (!extension) {
                    (0, log_1.log)("processAsset: could not create extension", { type: "warning" });
                    // NB: extension must exist now.
                    return [2 /*return*/, undefined];
                }
                storageLocationInfo = (0, getStorageLocationInfo_1.getStorageLocationInfo)(absoluteReferencingFilePath, modelName);
            ...
            case 4:
                ...
                //({ newRelativePath });
                console.log({ alt: alt, relativePath: relativePath });
