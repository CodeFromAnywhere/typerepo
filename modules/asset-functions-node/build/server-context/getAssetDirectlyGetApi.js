 ...
 */
var getAssetDirectlyGetApi = function (serverContext) {
    /**
    ...
    */
    var isDownload = (0, js_util_1.takeFirst)(serverContext === null || serverContext === void 0 ? void 0 : serverContext.query.isDownload) === "1";
    var projectRelativeAssetPath = (0, js_util_1.takeFirst)(serverContext === null || serverContext === void 0 ? void 0 : serverContext.query.projectRelativeAssetPath);
    ...
    if (!projectRelativeAssetPath) {
        console.log({ p: serverContext === null || serverContext === void 0 ? void 0 : serverContext.query });
        return {
            isSuccessful: false,
