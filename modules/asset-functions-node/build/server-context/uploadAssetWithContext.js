...
var ffmpeg_util_2 = require("ffmpeg-util");
/**
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, ffmpeg_util_1.convertToMp3)(functionFile.path, absoluteTemporaryDestinationPath)];
            case 3:
                resultingPath = _b.sent();
                return [3 /*break*/, 8];
            case 4:
                if (!(conversionInfo.targetFormat === "mp4")) return [3 /*break*/, 6];
                return [4 /*yield*/, (0, ffmpeg_util_2.convertToMp4)(functionFile.path, absoluteTemporaryDestinationPath)];
            case 5:
                resultingPath = _b.sent();
                return [3 /*break*/, 8];
