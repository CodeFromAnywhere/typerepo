...
*/
var getReferencedAssetGetApi = function (serverContext) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!serverContext) {
                    return [2 /*return*/, { isSuccessful: false, message: "No server context provided" }];
                }
                isDownload = (0, js_util_1.takeFirst)(serverContext.query.isDownload) === "1";
                projectRelativeReferencingFilePath = (0, js_util_1.takeFirst)(serverContext.query.projectRelativeReferencingFilePath);
                referencingFileRelativeAssetPath = (0, js_util_1.takeFirst)(serverContext === null || serverContext === void 0 ? void 0 : serverContext.query.referencingFileRelativeAssetPath);
