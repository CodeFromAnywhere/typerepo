...
var processItemAssets = function (item, interfaceName, operationName, customQueryConfig) { return __awaiter(void 0, void 0, void 0, function () {
    var projectRoot, absoluteReferencingFilePath, projectRelativeReferencingFilePath, assetParameters, assetsToPutOnObject;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!projectRoot)
                    return [2 /*return*/];
                return [4 /*yield*/, database_1.db.getDbFileLocationPath(item, operationName, interfaceName, customQueryConfig)];
            case 1:
                absoluteReferencingFilePath = _a.sent();
                if (!absoluteReferencingFilePath)
                    return [2 /*return*/, item];
                projectRelativeReferencingFilePath = (0, fs_util_js_1.makeRelative)(absoluteReferencingFilePath, projectRoot);
                assetParameters = (0, asset_functions_js_1.findAssetParametersRecursively)(item);
                            ...
                            switch (_c.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, Promise.all(value.map(function (asset) {
                                            return (0, processAsset_1.processAsset)(__assign(__assign({}, asset), { projectRelativeReferencingFilePath: projectRelativeReferencingFilePath, modelName: interfaceName }));
                                        }))];
                                case 1:
                                ...
                                case 2:
                                    ...
                                    return [4 /*yield*/, (0, processAsset_1.processAsset)(__assign(__assign({}, value), { projectRelativeReferencingFilePath: projectRelativeReferencingFilePath, modelName: interfaceName }))];
                                case 3:
                                    _b = _c.sent();
                                    return [3 /*break*/, 5];
                                case 4:
