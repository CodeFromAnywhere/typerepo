 ...
 */
var getStorageLocationInfo = function (absoluteReferencingFilePath, modelName) {
    ...
    if (modelName &&
        ...
        var databaseFolderRelativeReferenceLocationPath = (0, fs_util_js_1.makeRelative)(absoluteReferencingFilePath, databaseFolderBasePath);
        ...
        var absoluteAssetBaseFolderPath = isStoredInFolder
            ...
            : fs_util_1.path.join(databaseFolderBasePath, "".concat((0, convert_case_1.kebabCase)(modelName), "-assets"));
        /**
