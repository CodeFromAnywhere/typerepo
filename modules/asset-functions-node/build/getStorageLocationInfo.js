...
/**
         ...
         */
return{type:"database",absoluteAssetBaseFolderPath:(0,fs_util_js_1.makeRelative)(e,o).split("/").length>1?fs_util_1.path.parse(e).dir:fs_util_1.path.join(o,"".concat((0,convert_case_1.kebabCase)(t),"-assets"))}}
/**
