...
(0,log_1.log)("I don't support this usecase (type is an array of multiple types)... ".concat(r.type.join(",")),{type:"debug"});var t=Array.isArray(r.type)?r.type[0]:r.type,s=e?n.concat(e):n,a=(0,schema_util_1.getRefLink)(r.$ref),u=!!a&&n.includes(a);if(a&&!u){var o=i.find((function(e){return e.name===a}));
