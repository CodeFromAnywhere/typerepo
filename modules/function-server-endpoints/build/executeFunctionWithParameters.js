...
var executeFunctionWithParameters = function (functionName, parameters, serverContext) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, (0, function_functions_node_1.getPublicBundleConfig)()];
            case 1:
                publicBundleConfig = _c.sent();
                executionId = (0, model_types_1.generateId)();
                if (!(0, isGetEndpoint_1.isGetEndpoint)(functionName)) return [3 /*break*/, 3];
            ...
            case 5:
                ...
                if (!tsFunction) {
                    return [2 /*return*/, {
                            isSuccessful: false,
                            message: "TsFunction file could not be found in \"sdk-function-paths\" (".concat(functionName, "). Maybe you need to rebuild your operation and update your SDK?"),
                        }];
                }
            ...
            case 6:
                ...
                resultValidation = (0, db_recipes_1.validateResult)(functionName, result, tsFunction);
