...
var ToggleInput = function (_a) {
    var onChange = _a.onChange, value = _a.value, extra = _a.extra, config = _a.config, uniqueFieldId = _a.uniqueFieldId, errors = _a.errors, className = _a.className;
    config = config || {};
    var defaultClass = "";
    ...
    return ((0, jsx_runtime_1.jsxs)(react_with_native_1.Div, __assign({ className: "flex flex-row items-center ".concat(className || "") }, { children: [(0, jsx_runtime_1.jsx)(react_with_native_1.Toggle, { id: uniqueFieldId, 
