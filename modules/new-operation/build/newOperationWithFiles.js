...
srcFileContentObject, config) { return __awaiter(void 0, void 0, void 0, function () {
    var projectRoot, isSensible, destinationPath, indexFileContent, srcFileContentObjectWithIndex, actualBasePath, wishedBasePath, isOperationNew, shouldOverwrite, finalOperationBasePath, finalName, noBuild, isSuccesful, packageJsonPath, hasAvailablePackageJson, _a, newItem, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                destinationPath = (config === null || config === void 0 ? void 0 : config.destinationPath) || isSensible
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, fs_util_1.fs.writeFile(srcPath, content, "utf8")];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
            ...
            case 4:
                ...
                finalOperationBasePath = shouldOverwrite
                    ? wishedBasePath
                    : actualBasePath;
                finalName = (0, fs_util_1.getLastFolder)(finalOperationBasePath);
                // 6. yarn build there
            ...
            case 5:
                ...
                _b.label = 6;
            case 6:
                if (!shouldOverwrite) return [3 /*break*/, 12];
            ...
            case 11:
                ...
                _b.label = 12;
            case 12:
                if (!isOperationNew) return [3 /*break*/, 14];
                newItem = __assign(__assign({}, operationConfig), { operationName: finalName });
            ...
            case 13:
                ...
                _b.label = 14;
            case 14: return [2 /*return*/, finalOperationBasePath];
        }
    });
}); };
