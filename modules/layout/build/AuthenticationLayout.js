...
var AuthenticationLayout = function (props) {
    ...
    var nextPage = props.nextPage, pageProps = props.pageProps, menu = props.menu, customHeader = props.customHeader, custom404Page = props.custom404Page, overwriteDefaultPages = props.overwriteDefaultPages;
    ...
    var children = DefaultPage && !(overwriteDefaultPages === null || overwriteDefaultPages === void 0 ? void 0 : overwriteDefaultPages.includes(path)) ? ((0, jsx_runtime_1.jsx)(DefaultPage, {})) : ((0, jsx_runtime_1.jsx)(NextPage, __assign({}, pageProps)));
