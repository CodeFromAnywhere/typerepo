    ...
    return ((0, jsx_runtime_1.jsxs)(react_with_native_1.Div, __assign({ className: "dark:bg-gray-800", style: {
            ...
            alignItems: "center",
                            ...
                            : "#", style: { fontSize: 32 } }, { children: publicBundleConfig === null || publicBundleConfig === void 0 ? void 0 : publicBundleConfig.emoji })), (0, jsx_runtime_1.jsx)(react_with_native_1.P, __assign({ className: "font-bold pl-2" }, { children: publicBundleConfig === null || publicBundleConfig === void 0 ? void 0 : publicBundleConfig.name }))] })), (0, jsx_runtime_1.jsxs)(react_with_native_1.Div, __assign({ className: "flex flex-row items-center" }, { children: [(0, jsx_runtime_1.jsxs)(react_with_native_1.Div, { children: [((_a = props.publicBundleConfig) === null || _a === void 0 ? void 0 : _a.isGitRepoPublic) &&
                                props.publicBundleConfig.gitRepoUrl ? ((0, jsx_runtime_1.jsx)(react_with_native_1.P, { children: (0, jsx_runtime_1.jsx)(next_a_link_1.ALink, __assign({ className: "pr-2", target: "_blank", href: props.publicBundleConfig.gitRepoUrl }, { children: "\uD83D\uDC08 GitHub" })) })) : null, (0, jsx_runtime_1.jsx)(react_with_native_1.P, { children: (0, jsx_runtime_1.jsx)("a", __assign({ target: "_blank", href: "https://twitter.com/WKarsens" }, { children: "\uD83D\uDC24 Twitter" })) })] }), (0, jsx_runtime_1.jsx)(PingApi_1.PingApi, {}), (0, jsx_runtime_1.jsx)(react_with_native_1.Div, __assign({ className: "lg:hidden" }, { children: (0, jsx_runtime_1.jsx)(clickable_icon_1.ClickableIcon, { emoji: "\uD83D\uDD0D", onClick: function () { return setIsMobileMenuEnabled(!isMobileMenuEnabled); } }) })), (0, jsx_runtime_1.jsx)(authentication_1.MeAuthenticationInfo, {})] }))] })));
};
