...
exports.bundleFolderWithMarkdown = void 0;
var merge_1 = require("./parsing/merge");
var makeOutlineMarkdownString_1 = require("./makeOutlineMarkdownString");
 ...
 */
var bundleFolderWithMarkdown = function (outlineTitle, 
/**
 ...
 */
resultFileName) { return __awaiter(void 0, void 0, void 0, function () {
    var markdownParses, _a, merged, outline, outlineString;
    return __generator(this, function (_b) {
        markdownParses = markdownStrings.map(function (content) {
            return (0, markdown_parse_js_1.mdToJsonParse)(content);
        });
        _a = (0, merge_1.mergeMarkdownParse)(markdownParses, resultFileName), merged = _a.merged, outline = _a.outline;
        outlineString = (0, makeOutlineMarkdownString_1.makeOutlineMarkdownString)(outlineTitle, outline);
