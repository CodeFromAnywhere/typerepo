...
exports.updatePeer = void 0;
var database_1 = require("database");
var js_util_1 = require("js-util");
/**
 * Update one of your peers
 */
var updatePeer = function (slug, updatedValues) { return __awaiter(void 0, void 0, void 0, function () {
    var updateResult;
            ...
            case 1:
                ...
                return [2 /*return*/, {
                        ...
                        message: updateResult.isSuccesful
                            ? "Peer updated"
                            : "Something went wrong: ".concat(updateResult.message),
                    }];
        }
    });
}); };
