...
exports.getAllOperationSourcePaths = void 0;
 ...
 */
var getAllOperationSourcePaths = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var manualProjectRoot, operationFolders, operationSourceFolders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                operationSourceFolders = operationFolders.reduce(function (allSources, operationPath) {
                    var srcPath = fs_util_1.path.join(operationPath, "src");
                    if (!fs_util_1.fs.existsSync(srcPath))
                        return allSources;
                ...
                return [2 /*return*/, operationSourceFolders];
        }
    });
}); };
exports.getAllOperationSourcePaths = getAllOperationSourcePaths;
