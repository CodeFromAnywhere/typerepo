...
var compressImages_1 = require("../compressImages");
/**
 ...
 */
var compressImagesCli = function () { return __awaiter(void 0, void 0, void 0, function () {
    var argumentsArray;
        ...
        if (argumentsArray.length > 0) {
            (0, one_by_one_1.oneByOne)(argumentsArray, function (absoluteOrRelativePath) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            absoluteFolderPath = absoluteOrRelativePath.startsWith(".")
                            ...
                            return [4 /*yield*/, (0, compressImages_1.compressImages)(absoluteFolderPath)];
                        case 1:
                            // console.log({ operationNames, operationName });
                            _a.sent();
                            return [2 /*return*/];
...
compressImagesCli();
//# sourceMappingURL=compressImages.cli.js.map