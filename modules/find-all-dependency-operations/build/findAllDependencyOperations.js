 ...
 * all imports
 */
imports, packageJsons, operationName, 
/**
        ...
        switch (_b.label) {
            case 0:
                if (ignore === null || ignore === void 0 ? void 0 : ignore.includes(operationName))
                    return [2 /*return*/, []];
                packageJson = packageJsons.find(function (x) { return x.operationName === operationName; });
                if (!packageJson) {
                    console.log("WARN: couldn't find packagejson ".concat(operationName, ". weird..."), packageJsons.slice(0, 5));
                    return [2 /*return*/, []];
                }
                ...
                dependencyPromises = monorepoModules
                    ...
                    return (0, exports.findDependenciesRecursively)(imports, packageJsons, operationName, newAlready, ignore);
                });
...
var findAllDependencyOperations = function (_a) {
    var imports = _a.imports, packageJsons = _a.packageJsons, operationNames = _a.operationNames, ignoreOperationNames = _a.ignoreOperationNames, ignoreFilter = _a.ignoreFilter;
            ...
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, one_by_one_1.oneByOne)(operationNames, function (operationName) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            ...
                            return [2 /*return*/, (0, exports.findDependenciesRecursively)(imports, packageJsons, operationName, operationNames, ignoreOperationNames, ignoreFilter)];
                        });
                    }); })];
                case 1:
                    dependencies = (_b.sent()).flat();
