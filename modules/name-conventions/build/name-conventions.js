...
exports.isCalculatedParameter = exports.getParameterContentType = exports.isGeneratedParameterName = exports.generatedParameterNames = exports.referencePluralParameterNames = exports.referenceParameterNames = exports.passwordTextParameterNames = exports.markdownTextParameterNames = exports.parameterNames = exports.patternMatchers = void 0;
exports.patternMatchers = [
    {
        pattern: "%m",
        matches: "modelName",
    },
 ...
 */
exports.markdownTextParameterNames = [
    "markdown",
    "description",
    "content",
];
exports.passwordTextParameterNames = ["password", "repeatPassword"];
exports.referenceParameterNames = ["slug", "id"];
// NB: misspelling on purpose to keep simple parsing from singular to plural
exports.referencePluralParameterNames = ["slugs", "ids"];
exports.generatedParameterNames = [
    "createdAt",
    "updatedAt",
    "deletedAt",
...
var isGeneratedParameterName = function (parameterName) {
    var generatedPatterns = exports.parameterNames
        .filter(function (x) { return x.contentType.length === 1 && x.contentType[0] === "generated"; })
        .map(function (x) { return x.pattern; });
    // TODO: match the patterns against the name to find match
};
exports.isGeneratedParameterName = isGeneratedParameterName;
var getParameterContentType = function (parameterName) {
 ...
 */
var isCalculatedParameter = function (parameterName) {
    return (exports.generatedParameterNames.includes(parameterName) ||
