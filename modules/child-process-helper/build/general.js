 ...
 */
var execAsync = function (command, execOptions) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, new Promise(function (resolve) {
                    var _a;
                    var execution = (0, node_child_process_1.exec)(command, execOptions, function (error, stdout, stderr) {
                    ...
                    (_a = execution.stdout) === null || _a === void 0 ? void 0 : _a.on("data", function (data) {
                        console.log(data);
                    });
                })];
            case 1:
