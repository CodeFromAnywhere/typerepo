...
var processChatGptPrompt = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var contextContent, contextualPromptSlug, customPromptContent, saveNewPromptWithName, prompt_projectRelativePath, selectionContent, isHeadless, isDeferred, thread, projectRoot, prompt_absolutePath, exists, contextualPrompt, finalPrompt, useChatGpt, promiseResult, processPromptFunctionResult, _a, result;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, getContextualPrompt_1.getContextualPrompt)(contextualPromptSlug, customPromptContent, saveNewPromptWithName || null)];
            case 1:
                ...
                finalPrompt = contextualPrompt.promptContent
