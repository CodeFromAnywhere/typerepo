    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 8:
                ...
                return [4 /*yield*/, database_1.db.update("OperationIndex", function () { return true; }, function (operationIndex) { return (__assign(__assign({}, operationIndex), { dependenciesBuildsFailed: true })); }, { operationName: operationName, manualProjectRoot: operationManualProjectRoot })];
            case 9:
                _e.sent();
                return [2 /*return*/, false];
            case 10:
            ...
            case 16:
                _e.sent();
                if (!!filePaths) return [3 /*break*/, 19];
                _c = (_b = Promise).all;
                return [4 /*yield*/, (0, get_package_source_paths_1.getPackageSourcePaths)({
                        operationBasePath: operationBasePath,
                        ignoreIndexFiles: true,
                    })];
            case 17: return [4 /*yield*/, _c.apply(_b, [_e.sent()])];
            case 18:
                //files from src
            ...
            case 21:
                ...
                buildSucceeded = true;
                if (!isBuildNeeded) return [3 /*break*/, 25];
                skipMinify = (_d = packageJson === null || packageJson === void 0 ? void 0 : packageJson.sensible) === null || _d === void 0 ? void 0 : _d.skipMinify;
            ...
            case 24:
                _e.sent();
                _e.label = 25;
            case 25: return [4 /*yield*/, (0, generateJsonSchemas_1.generateJsonSchemas)(operationManualProjectRoot, operationName)];
            case 26:
                _e.sent();
                return [4 /*yield*/, database_1.db.update("OperationIndex", function () { return true; }, function (operationIndex) { return (__assign(__assign({}, operationIndex), { buildSucceeded: buildSucceeded })); }, { operationName: operationName, manualProjectRoot: operationManualProjectRoot })];
            case 27:
                _e.sent();
            ...
            case 28:
                ...
                if (!operationSummary) return [3 /*break*/, 30];
            ...
            case 29:
                ...
                _e.sent();
                _e.label = 30;
            case 30: return [4 /*yield*/, database_1.db.update("OperationIndex", function () { return true; }, function (operationIndex) { return (__assign(__assign({}, operationIndex), { indexImportExportError: "", lintProblems: lintProblems })); }, { operationName: operationName, manualProjectRoot: operationManualProjectRoot })];
            case 31:
                _e.sent();
                return [4 /*yield*/, (0, operation_util_1.recalculateOperationIndexJson)(operationBasePath, operationManualProjectRoot)];
            case 32:
                _e.sent();
                if (!!noExit) return [3 /*break*/, 34];
