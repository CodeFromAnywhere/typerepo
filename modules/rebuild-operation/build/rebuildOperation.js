...
var isGeneratedOperation_1 = require("./isGeneratedOperation");
/**
 * This function rebuilds an operation and re-indexes (part of) its files.
 */
var rebuildOperation = function (_a) {
    var operationBasePath = _a.operationBasePath, manualProjectRoot = _a.manualProjectRoot, filePaths = _a.filePaths, force = _a.force, debug = _a.debug, noExit = _a.noExit, _b = _a.stack, stack = _b === void 0 ? [] : _b, noUnresolvedRebuilding = _a.noUnresolvedRebuilding;
    return __awaiter(void 0, void 0, void 0, function () {
        var operationName, stackPrefix, lintProblems, skip, result, _c, message, success, imports, unresolvedModules, succeededArray, _d, _e, indexPath, isBuildNeeded, buildSucceeded, imports, dependantOperationNames, testableOperations, testPromises;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    operationName = (0, fs_util_1.getLastFolder)(operationBasePath);
                    if ((0, isSdkOperation_1.isSdkOperation)(operationBasePath) ||
                        (0, isGeneratedOperation_1.isGeneratedOperation)(operationBasePath)) {
                ...
                case 2:
                    _f.sent();
                    return [2 /*return*/, false];
                case 3: return [4 /*yield*/, (0, shouldSkip_1.shouldSkip)({ operationBasePath: operationBasePath, debug: debug, force: force })];
                case 4:
                    skip = _f.sent();
                    if (skip) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, get_imports_exports_1.findAndWriteImportsExports)({
                            operationBasePath: operationBasePath,
                            manualProjectRoot: manualProjectRoot,
                        })];
                case 6:
                    _c = _f.sent(), message = _c.message, success = _c.success;
                    if (!!success) return [3 /*break*/, 8];
                    (0, log_1.log)("".concat(stackPrefix, "Couldn't write imports/exports."));
                    return [4 /*yield*/, database_1.db.update("OperationIndex", function () { return true; }, function (operationIndex) { return (__assign(__assign({}, operationIndex), { indexImportExportError: message })); }, { operationName: operationName })];
                case 7:
                    _f.sent();
                    return [2 /*return*/, false];
                case 8:
                    if (!(operationName !== "sdk")) return [3 /*break*/, 16];
                ...
                case 9:
                    ...
                    if (!(unresolvedModules.length > 0)) return [3 /*break*/, 15];
                    if (!noUnresolvedRebuilding) return [3 /*break*/, 11];
                ...
                case 12:
                    succeededArray = _f.sent();
                    if (!!(0, js_util_1.isAllTrue)(succeededArray)) return [3 /*break*/, 14];
                ...
                case 17:
                    _f.sent();
                    if (!!filePaths) return [3 /*break*/, 20];
                    _e = (_d = Promise).all;
                    return [4 /*yield*/, (0, get_package_source_paths_1.getPackageSourcePaths)({
                            operationBasePath: operationBasePath,
                            ignoreIndexFiles: true,
                        })];
                case 18: return [4 /*yield*/, _e.apply(_d, [_f.sent()])];
                case 19:
                    //files from src
                    filePaths = (_f.sent()).filter(js_util_1.notEmpty);
                    _f.label = 20;
                case 20:
                ...
                case 22:
                    ...
                    buildSucceeded = true;
                    if (!isBuildNeeded) return [3 /*break*/, 26];
                    return [4 /*yield*/, (0, yarnBuild_1.yarnBuild)(operationBasePath, {
                            rmFirst: false,
                        })];
                case 23:
                    buildSucceeded = _f.sent();
                    return [4 /*yield*/, database_1.db.get("TsImport", {
                            manualProjectRoot: manualProjectRoot,
                        })];
                case 24:
                ...
                case 25:
                    _f.sent();
                    _f.label = 26;
                case 26: return [4 /*yield*/, database_1.db.update("OperationIndex", function () { return true; }, function (operationIndex) { return (__assign(__assign({}, operationIndex), { buildSucceeded: buildSucceeded })); }, { operationName: operationName })];
                case 27:
                    _f.sent();
