...
var shouldSkip = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var operationBasePath, debug, force, operationName, operationIndex, srcPath, srcUpdatedAt, hasIndexFolder, noBuildFolder, isBuildNeeded;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                operationBasePath = config.operationBasePath, debug = config.debug, force = config.force;
