...
var generateOperationsSdk = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var skipYarnInstall, dryrun, manualProjectRoot, projectRoot, operationFolderPaths, operationNamePathRows, operationObjectString, operationConfig;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, new_operation_1.getOperationConfig)("sdk-operations", "This is the operation where all operations are comprised")];
            case 2:
                operationConfig = _a.sent();
                return [4 /*yield*/, (0, new_operation_1.newOperationWithFiles)(operationConfig, { "src/sdk-operations.ts": operationObjectString }, { overwriteIfExists: true, skipYarnInstall: skipYarnInstall, manualProjectRoot: manualProjectRoot, dryrun: dryrun })];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
