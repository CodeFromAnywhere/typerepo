...
var generateOperationsSdk = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var skipYarnInstall, dryrun, manualProjectRoot, projectRoot, operationFolderPaths, operationNamePathRows, operationObjectString, operationConfig, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, (0, new_template_1.newOperationWithFiles)(operationConfig, { "src/sdk-operations.ts": operationObjectString }, { overwriteIfExists: true, skipYarnInstall: skipYarnInstall, manualProjectRoot: manualProjectRoot, dryrun: dryrun })];
            case 4:
                _c.sent();
                return [2 /*return*/];
        }
