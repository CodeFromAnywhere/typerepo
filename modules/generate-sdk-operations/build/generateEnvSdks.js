        ...
        switch (_b.label) {
            case 0:
                ...
                srcFileContentObject = (_a = {},
                    ...
                    _a);
                return [4 /*yield*/, (0, new_operation_1.getOperationConfig)(operationName, description)];
            case 1:
                operationConfig = _b.sent();
                return [4 /*yield*/, (0, new_operation_1.newOperationWithFiles)(operationConfig, srcFileContentObject, { manualProjectRoot: projectRoot, skipYarnInstall: skipYarnInstall, dryrun: dryrun })];
            case 2:
