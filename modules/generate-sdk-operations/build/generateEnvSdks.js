...
bundleConfig, type, config) { return __awaiter(void 0, void 0, void 0, function () {
    var operationName, description, projectRoot, skipYarnInstall, dryrun, envVariables, realEnv, typescriptFileString, localComment, localTypescriptFileString, srcFileContentObject, operationBasePath;
    var _a;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                srcFileContentObject = (_a = {},
                    ...
                    _a);
                return [4 /*yield*/, (0, new_template_1.newOperationWithFiles)(operationName, description, srcFileContentObject, { manualProjectRoot: projectRoot, skipYarnInstall: skipYarnInstall, dryrun: dryrun })];
            case 2:
