...
bundleConfig, config) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                if (!bundleConfig) return [3 /*break*/, 4];
            ...
            case 3:
                _a.sent();
                _a.label = 4;
            case 4: return [4 /*yield*/, (0, generateOperationsSdk_1.generateOperationsSdk)({
                    manualProjectRoot: manualProjectRoot,
                    skipYarnInstall: yarnInstallAfter,
                    dryrun: dryrun,
                })];
            case 5:
                ...
                if (yarnInstallAfter) {
                    ...
                    try {
                        result = (0, child_process_1.execSync)("yarn --prefer-offline", {
                            cwd: projectRoot,
                            encoding: "utf8",
                            stdio: "pipe",
                        });
