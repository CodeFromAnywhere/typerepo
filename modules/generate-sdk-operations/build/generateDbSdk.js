...
var generateDbSdk = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var manualProjectRoot, skipYarnInstall, dryrun, allDbModels, typeImportsString, exportDbTypesString, exportDbKeysString, exportDbModelEnumString, exportModelQueryConfigString, indexationString, operationConfig;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, database_1.db.get("TsInterface", { manualProjectRoot: manualProjectRoot })];
            case 1:
                allDbModels = (_a.sent())
                ...
                indexationString = "// THIS FILE HAS BEEN GENERATED\n"
                    ...
                    .concat("\n")
                    .concat("// THANK YOU\n");
                return [4 /*yield*/, (0, new_operation_1.getOperationConfig)("sdk-db", "This is the operation where all Db models are comprised")];
            case 2:
                operationConfig = _a.sent();
                return [4 /*yield*/, (0, new_operation_1.newOperationWithFiles)(operationConfig, { "src/sdk-db.ts": indexationString }, { overwriteIfExists: true, skipYarnInstall: skipYarnInstall, manualProjectRoot: manualProjectRoot, dryrun: dryrun })];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
