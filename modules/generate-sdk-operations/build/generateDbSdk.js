...
var generateDbSdk = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var manualProjectRoot, skipYarnInstall, dryrun, allDbModels, typeImportsString, exportDbTypesString, exportDbKeysString, exportDbModelEnumString, exportModelQueryConfigString, indexationString, operationConfig, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, (0, new_template_1.newOperationWithFiles)(operationConfig, { "src/sdk-db.ts": indexationString }, { overwriteIfExists: true, skipYarnInstall: skipYarnInstall, manualProjectRoot: manualProjectRoot, dryrun: dryrun })];
            case 4:
                _c.sent();
                return [2 /*return*/];
        }
