...
exports.exploreOperation = void 0;
 ...
 */
var exploreOperation = function (operationBasePath) { return __awaiter(void 0, void 0, void 0, function () {
    var srcPath, docsPath, rootExploreResults, docsExploreResults, docsExploreResultsWithBasePath, srcExploreResults, srcExploreResultsWithBasePath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                srcPath = fs_util_1.path.join(operationBasePath, "src");
                docsPath = fs_util_1.path.join(operationBasePath, "docs");
            ...
            case 2:
                docsExploreResults = _a.sent();
                docsExploreResultsWithBasePath = docsExploreResults.length > 0
            ...
            case 3:
                srcExploreResults = (_a.sent())
                    // NB: filter out index files, they're not interesting for this usecase
                    .filter(function (x) { return !x.path.includes("/src/index.ts"); });
                srcExploreResultsWithBasePath = srcExploreResults.length > 0
                    ? srcExploreResults.concat([{ path: srcPath, isFolder: true }])
                    : [];
                return [2 /*return*/, rootExploreResults
                        .concat(docsExploreResultsWithBasePath)
                        .concat(srcExploreResultsWithBasePath)];
        }
    });
}); };
exports.exploreOperation = exploreOperation;
//# sourceMappingURL=exploreOperation.js.map