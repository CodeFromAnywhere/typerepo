...
var facebookLogin = function (props) { return __awaiter(void 0, void 0, void 0, function () {
    var email, password, page;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                email = props.email, password = props.password, page = props.page;
                // type email
