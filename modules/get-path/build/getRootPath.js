 ...
 */
exports.osRootFoldersConst=["assets","backups","bundled","cloned","bundles","distributions","operations"],
/**
 ...
 */
o,e){var t=(null==e?void 0:e.manualProjectRoot)||(0,getProjectRoot_1.getProjectRoot)();if(t){if(!o)return t;if((0,isSensibleProject_1.isSensibleProject)(t)){if(exports.projectRootFolders.includes(o)){var r="text"===o?"docs":"operations"===o?"packages":o===filename_conventions_1.databaseFolderName?filename_conventions_1.databaseFolderName:null;return r?fs_util_1.path.resolve(t,r):void console.log("get root path: This should never happen")}console.log("This can't be done in a sensible project")}
// non-sensible projects
else{if(exports.projectRootFolders.concat(exports.osRootFolders).includes(o))return fs_util_1.path.resolve(t,o);console.log("getRootPath: Should never happen, probably a wrong input was provided:",{name:o})}}};exports.getRootPath=getRootPath;
