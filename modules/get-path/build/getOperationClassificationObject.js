...
exports.getOperationClassificationObject = void 0;
var fs_util_1 = require("fs-util");
var js_util_1 = require("js-util");
var k_explore_1 = require("k-explore");
var getOperationClassification_1 = require("./getOperationClassification");
var getOperationClassificationObject = function () { return __awaiter(void 0, void 0, void 0, function () {
    var operationFolders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, k_explore_1.exploreOperationFolders)({})];
            case 1:
                operationFolders = _a.sent();
                return [2 /*return*/, (0, js_util_1.mergeObjectsArray)(operationFolders
                        .map(function (operationBasePath) {
                        var _a;
                        var operationClassification = (0, getOperationClassification_1.getOperationClassification)(operationBasePath);
...
exports.getOperationClassificationObject = getOperationClassificationObject;
