...
- gets an intro from those markdown files and returns that (uses `getMarkdownIntro`)
   ...
   */
var getFolderExplorationInfo = function (webPages, queryPath, projectRoot) { return __awaiter(void 0, void 0, void 0, function () {
    var childrenKeys, potentialReadmePath, readmeMarkdownParse, _a, queryPathTitle, readmeInfo, title, description, children;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                childrenKeys = (0, getChildren_1.getChildren)(webPages, queryPath);
