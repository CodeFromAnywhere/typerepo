...
var stripReadmeFromFolder_1 = require("./stripReadmeFromFolder");
/**
                            ...
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    markdownReaderPages = publicMarkdownFileAbsolutePaths.map(function (x) {
                                        ...
                                        var pathWithoutReadme = (0, stripReadmeFromFolder_1.stripReadmeFromFolder)(filePath);
                                        var pathWithoutExtensions = (0, removeExtensionsFromPath_1.removeExtensionsFromPath)(pathWithoutReadme);
                                        var mappedQueryPath = mapQueryPath
                                            ? mapQueryPath(pathWithoutExtensions)
                                            : pathWithoutExtensions;
                                        var customQueryPrefix = config.queryPathCustomPrefix
                                            ? config.queryPathCustomPrefix(basePath)
                                            : undefined;
                                        var relativeBasePath = (0, get_path_1.makeRelative)(basePath, projectRoot);
                                        console.log({ mappedQueryPath: mappedQueryPath, relativeBasePath: relativeBasePath });
                                        var queryPath = customQueryPrefix
