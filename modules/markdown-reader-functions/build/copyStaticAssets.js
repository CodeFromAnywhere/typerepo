...
*/
var copyStaticAssets = function (readerWebPages, config) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!nextWebFolder)
                    return [2 /*return*/];
                referencePathsPromises = readerWebPages.map(function (page) { return __awaiter(void 0, void 0, void 0, function () {
                    var absoluteMarkdownFilePath, markdownString, referencePaths;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!page.pageData.projectRelativeFilePath)
                                    return [2 /*return*/];
            ...
            case 2:
                ...
                projectRelativeReferencePaths = absoluteReferencePaths.map(function (x) {
                    return (0, fs_util_js_1.makeRelative)(x, projectRoot);
                });
