...
var getOperationPages = function (projectRoot, bundleMarkdownReaderConfig) { return __awaiter(void 0, void 0, void 0, function () {
    var operationBasePaths, operationPagesPerType, _a, operationsPages, operationPages;
    var _b;
        ...
        switch (_c.label) {
                            ...
                            switch (_b.label) {
                                ...
                                case 1:
                                    folders = (_b.sent()).map(function (result) { return ({
                                        projectRelativePath: (0, fs_util_js_1.makeRelative)(result, projectRoot),
                                    }); });
                                    projectRelativeBasePath = (0, fs_util_js_1.makeRelative)(absoluteBasePath, projectRoot);
                                    pages = folders.map(function (folder) {
                                         ...
                                         */
                                        var isMenuHidden = projectRelativeBasePath === "apps" &&
                                        ...
                                        var readerWebPage = {
                                            ...
                                            pageData: {
                                                projectRelativeFilePath: fs_util_1.path.join(folder.projectRelativePath, "README.md"),
            ...
            case 1:
                ...
                operationsPages = ((_b = bundleMarkdownReaderConfig === null || bundleMarkdownReaderConfig === void 0 ? void 0 : bundleMarkdownReaderConfig.customOperationNames) === null || _b === void 0 ? void 0 : _b.map(function (operationName) {
                    ...
                    var readerWebPage = {
                        pageData: {
                            projectRelativeFilePath: fs_util_1.path.join(projectRelativeOperationPath, "README.md"),
                        },
                ...
                operationPages = (0, get_path_1.isBundle)(projectRoot)
