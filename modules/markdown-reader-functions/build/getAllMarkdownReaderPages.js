...
var getReaderTodoPages_1 = require("./getReaderTodoPages");
...
var getAllMarkdownReaderPages = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var projectRoot, publicBundleConfig, bundleMarkdownReaderConfig, docsPaths, customOperationDocsPaths, customOperationDocsPages, relativeDocsPages, operationPages, markdownModelTypePages, todoPages, mainReadme, dictionaryPage, allPages, filteredPages;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                docsPaths = _b.sent();
                customOperationDocsPaths = ((_a = bundleMarkdownReaderConfig === null || bundleMarkdownReaderConfig === void 0 ? void 0 : bundleMarkdownReaderConfig.customOperationNames) === null || _a === void 0 ? void 0 : _a.map(function (operationName) {
                    var relativeOperationPath = sdk_operations_1.operations[operationName];
                    if (!relativeOperationPath)
                        return;
                    var absoluteDocsPath = fs_util_1.path.join(projectRoot, relativeOperationPath, "docs");
                    if (!fs_util_1.fs.existsSync(absoluteDocsPath))
                        return;
                    return {
                        absoluteDocsPath: absoluteDocsPath,
                        queryPath: (bundleMarkdownReaderConfig === null || bundleMarkdownReaderConfig === void 0 ? void 0 : bundleMarkdownReaderConfig.docsInRoot)
                            ? operationName
                            : "docs/".concat(operationName),
                    };
                }).filter(js_util_1.notEmpty)) || [];
                return [4 /*yield*/, (0, getMarkdownReaderPages_1.getMarkdownReaderPages)({
                        projectRoot: projectRoot,
                        basePaths: customOperationDocsPaths.map(function (x) { return x.absoluteDocsPath; }),
                        queryPathCustomPrefix: function (basePath) {
                            var _a;
                            return (_a = customOperationDocsPaths.find(function (x) { return x.absoluteDocsPath === basePath; })) === null || _a === void 0 ? void 0 : _a.queryPath;
                        },
                    })];
            case 3:
                customOperationDocsPages = _b.sent();
                return [4 /*yield*/, (0, getMarkdownReaderPages_1.getMarkdownReaderPages)({
                        projectRoot: projectRoot,
                        basePaths: docsPaths,
            ...
            case 7:
                ...
                allPages = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([
                    mainReadme
                ], relativeDocsPages, true), customOperationDocsPages, true), operationPages, true), [
                ...
                filteredPages = allPages.filter((0, js_util_1.onlyUnique2)(function (a, b) { return a.queryPath === b.queryPath; }));
