...
exports.referencePluralParameterNames=["slugs","ids","indexs"],exports.generatedParameterNames=["createdAt","updatedAt","deletedAt","createdFirstAt","slug","id","index","indexRelative"];const isGeneratedParameterName=e=>{parameterNames.filter((e=>1===e.contentType.length&&"generated"===e.contentType[0])).map((e=>e.pattern));
