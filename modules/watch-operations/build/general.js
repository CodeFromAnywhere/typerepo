...
exports.gitCommitAllCron = exports.exitIfOperationsChange = void 0;
 ...
 */
var exitIfOperationsChange = function (allOperationSourcePaths, manualProjectRoot) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!isSame) {
                        (0, log_1.log)("👀 I detected a change in your operations, restarting", {
                            type: "warning",
                        });
                        process.exit();
                    }
...
var gitCommitAllCron = function (manualProjectRoot) {
    setInterval(function () {
        try {
            // NB: This doesn't work well with nested .git folders!
            (0, child_process_1.execSync)("[[ `git status --porcelain .` ]] && git add . && git commit -m 'Automatic commit'", { cwd: manualProjectRoot, stdio: "inherit" });
        }
        catch (_a) { }
    }, 1000 * 3600);
};
exports.gitCommitAllCron = gitCommitAllCron;
