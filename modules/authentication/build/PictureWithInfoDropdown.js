...
var PictureWithInfoDropdown = function (props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_with_native_1.Div, __assign({ className: "relative" }, { children: [(0, jsx_runtime_1.jsxs)(react_with_native_1.Div, __assign({ className: "cursor-pointer flex flex-row justify-end pr-2 items-center gap gap-2", onClick: onClickCurrent || toggleDropdown }, { children: [isLoading ? ((0, jsx_runtime_1.jsx)(fancy_loader_1.FancyLoader, {})) : current.pictureUrl ? ((0, jsx_runtime_1.jsx)(react_with_native_2.Image, { src: current.pictureUrl, className: "rounded-full w-8 h-8 border border-black p-0.5 bg-gray-400" })) : null, (0, jsx_runtime_1.jsx)(react_with_native_1.P, { children: current.info })] })), (0, jsx_runtime_1.jsx)(react_with_native_1.Div, __assign({ className: "relative" }, { children: showDropdown ? ((0, jsx_runtime_1.jsxs)(react_with_native_1.Div, __assign({ className: "absolute top-0 right-0 bg-slate-400 min-w-[200px] rounded-md" }, { children: [(0, jsx_runtime_1.jsx)("b", { children: "Your accounts" }), dropdown.map(function (item) {
