...
import { Storing, DbFileLocation } from "model-types";
import { AnyModelObject, AugmentedAnyModelType, DbQueryResult } from "../types";
/**
 * upsert an item into storage in any storage method
 */
export declare const upsertItems: <TModels extends AnyModelObject = any, TModelName extends string = any>(dbStorageMethod: DbStorageMethod, dbFileLocation: DbFileLocation, storingItems: Storing<TModels[TModelName]> | Storing<TModels[TModelName]>[]) => Promise<DbQueryResult>;
/**
