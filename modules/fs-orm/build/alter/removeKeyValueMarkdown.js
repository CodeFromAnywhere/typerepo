...
var n=r.categoryStack.concat(r.slug).join(","),a=e.filter((function(e){var t=e.slug===r.slug,a=e.categoryStack.join(",").startsWith(n);return!t&&!a}));return{newStoredData:a,amountRemoved:e.length-a.length,isSuccesful:!0,message:"removed header and all it's children"}}
...
var o=u[0],l=e.find((function(e){return e.slug===(0,getParentSlug_1.getParentSlug)(o)})),i=e.filter((function(e){return e.slug!==o.slug&&e.slug!==(0,getParentSlug_1.getParentSlug)(o)}));if(!l)return{isSuccesful:!0,amountRemoved:e.length-i.length,message:"Removed it from the root",newStoredData:i};
/**
    ...
    */var g=(0,getParentSlug_1.getParentSlug)(l),c=i.findIndex((function(e){return e.slug===g})),d=__assign(__assign({},l),{isHeaderCalculated:!1});if(-1===c){
