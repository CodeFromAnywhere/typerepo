...
/**
    ...
    */
// 1
var o=__assign(__assign({},i),{isHeaderCalculated:!0}),u=[o,t],l=(0,js_util_1.removeIndexFromArray)(e,s),d=(0,js_util_1.findLastIndex)(l,(function(e){return e.categoryStack.join(",")===o.categoryStack.join(",")&&!e.isHeaderCalculated}))||
...
s-1;
// 2
return{amountUpdated:1,amountInserted:1,newStoredData:(0,js_util_1.insertAt)(l,u,d+1),message:"Inserted into an item (made that item a category, moved it)"}};exports.upsertKeyValueMarkdown=upsertKeyValueMarkdown;
