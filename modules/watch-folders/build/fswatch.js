 ...
 * uses fs.watch
 * */
var watchFoldersFs = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_c) {
            folders.map(function (folder) {
                (0, fs_1.watch)(folder, { recursive: true, encoding: "utf8" }, function (eventType, filename) { return __awaiter(void 0, void 0, void 0, function () {
                    var alreadyPending, lastPending, time, basePath, operationBasePath, fullPath;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                alreadyPending = pending.filter(function (x) { return x.filename === filename; });
                                ...
                                if (lastPending && Date.now() - lastPending.time < 5000) {
                                    (0, log_1.log)("double trigger of ".concat(filename, ", ignoring"), { type: "warning" });
                                    return [2 /*return*/];
                                }
                                ...
                                time = Date.now();
                                pending.push({ filename: filename, time: time });
                                basePath = folder;
                                operationBasePath = fs_util_1.path.join(basePath, "..");
                                fullPath = fs_util_1.path.join(folder, filename);
                            ...
                            case 1:
                                ...
                                pending = pending.filter(function (p) { return p.filename === filename && p.time === time; });
                                return [2 /*return*/];
                        }
                    });
                }); });
...
exports.watchFoldersFs = watchFoldersFs;
