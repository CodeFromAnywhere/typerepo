    ...
    var elements = parameters
        ...
        if (assetInputType && projectRelativeStorageFilePath) {
            ...
            return ((0, jsx_runtime_1.jsxs)(react_with_native_1.Div, { children: [(0, renderParameterTitle_1.renderParameterTitle)(parameter, isDebug), (0, jsx_runtime_1.jsx)(AssetInput, { value: parameterValue ? (0, js_util_1.makeArray)(parameterValue) : [], onChange: function (newValue) {
                        ...
                        }, className: "w-96", extra: assetInputExtra, 
                        // parameter={parameter}
        ...
        if ((_d = parameter.simplifiedSchema) === null || _d === void 0 ? void 0 : _d.enum) {
            ...
            var enumItems = parameter.simplifiedSchema.enum.map(function (enumString) {
                return {
                    ...
                    label: (0, convert_case_2.humanCase)(String(enumString)),
                };
            });
        ...
        var lastWord = (0, convert_case_1.lowerCaseArray)(parameter.name).pop();
        var isTextArea = name_conventions_1.markdownTextParameterNames.includes(lastWord);
        if (isTextArea) {
            return ((0, jsx_runtime_1.jsxs)(react_with_native_1.Div, { children: [(0, renderParameterTitle_1.renderParameterTitle)(parameter, isDebug), (0, jsx_runtime_1.jsx)(react_with_native_1.Div, __assign({ className: "w-full h-[300px]" }, { children: (0, jsx_runtime_1.jsx)(writer_input_1.WriterInput, { className: "".concat(react_with_native_ui_1.UI.bareInput, " h-[300px] bg-white"), value: value || "", onChange: onChangeText, hideButtons: true, initialWriterView: "edit", type: "markdown", projectRelativeFilePath: projectRelativeStorageFilePath }) }))] }, uniqueFieldId));
        }
