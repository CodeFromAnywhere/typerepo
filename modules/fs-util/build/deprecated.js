...
// node packages
var path_1=__importDefault(require("path")),graceful_fs_1=require("graceful-fs"),js_util_1=require("js-util"),parseMd_1=require("./parseMd"),js_1=require("./js"),importFromFiles=function(e){var r=e.files,t=e.importStrategy,i=void 0===t?"default":t,s=e.list,n=e.guard;return r.map((function(e){var r=require(e);if("default"===i)return r.default||r;if("fileName"===i){var t=(0,js_1.withoutExtension)(e.split("/").pop());return r[t]}return"list"===i?s?(0,exports.mergeObjectsArray)(s.map((function(e){var t;return(t={})[e]=r[e],t}))):{}:void 0})).filter((function(e){return n?n(e)&&e:e}))};
// external packages
