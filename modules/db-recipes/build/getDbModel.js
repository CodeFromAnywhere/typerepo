...
config) { return __awaiter(void 0, void 0, void 0, function () {
    var indexes, index, data, slicedStartData, slicedLimitData, hasMore, filteredData, sortedData, mergedConfig, fileLocations;
    var _a;
        ...
        switch (_b.label) {
            ...
            case 2:
                ...
                filteredData = ((_a = config === null || config === void 0 ? void 0 : config.dataFilters) === null || _a === void 0 ? void 0 : _a.length)
                    ? config === null || config === void 0 ? void 0 : config.dataFilters.reduce(function (filteredData, dataFilter) {
                        var newFilteredData = filteredData.filter(function (item) {
                            var key = dataFilter.objectParameterKey;
                            var value = item[key];
                ...
                sortedData = (config === null || config === void 0 ? void 0 : config.sortParameter) && (config === null || config === void 0 ? void 0 : config.sortDirection)
                    ...
                    : filteredData;
                mergedConfig = (0, database_1.getMergedQueryConfig)(interfaceName);
                return [4 /*yield*/, (0, fs_orm_1.getDatabaseFiles)(interfaceName, mergedConfig)];
            case 3:
                fileLocations = (_b.sent()).map(function (x) { return x.projectRelativePath; });
                return [2 /*return*/, {
                        start: config === null || config === void 0 ? void 0 : config.start,
