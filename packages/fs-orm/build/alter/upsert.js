 ...
 */
t){var r=(0,js_util_1.makeArray)(t),u=0,i=e.map((function(e){if(e){if(-1===r.findIndex((function(t){if(!t)return(0,log_1.log)("weird item found in your data, replacing",{type:"debug"}),!0;var r=t.id===e.id,u=void 0!==t.slug&&t.slug===e.slug;
