...
export type OptionalForCreationKeys<TModel> = Exclude<
  | (TModel extends TimeTypes ? keyof TimeTypes : null)
  | (TModel extends SlugModelProperties ? "slug" | "language" : null)
  | keyof AnyModelType,
  null
>;
 ...
 */
export type OptionalForCreation<TModel extends { [key: string]: any }> =
  OptionalForCreationKeys<TModel> extends keyof TModel
    ? OptionalForCreationKeys<TModel>
    : never;
 ...
 */
export type Creation<TModel extends { [key: string]: any }> = MakeOptional<
  TModel,
  OptionalForCreation<TModel>
>;
 ...
 */
export type Storing<TModel extends { [key: string]: any }> = Omit<
  TModel,
  ShouldNotBeStored
>;
