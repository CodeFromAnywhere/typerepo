...
var shouldSkip = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var operationBasePath, debug, force, rebuildUpdatedAt, operationName, operationIndex, srcPath, srcUpdatedAt, hasIndexFolder, noBuildFolder, isBuildNeeded;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                operationBasePath = config.operationBasePath, debug = config.debug, force = config.force, rebuildUpdatedAt = config.rebuildUpdatedAt;
                operationName = (0, fs_util_1.getLastFolder)(operationBasePath);
                if (force) {
                    console.log("Not skipping (force)");
                    return [2 /*return*/, false];
                }
                return [4 /*yield*/, database_1.db.get("OperationIndex", { operationName: operationName })];
            case 1:
                operationIndex = (_a.sent())[0];
                if (!operationIndex) {
