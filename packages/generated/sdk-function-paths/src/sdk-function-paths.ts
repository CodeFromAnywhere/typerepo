export const sdkFunctionPaths = {
  ...
  "SearchBar": "/apps/search-web/db/ts-functions/search-bar.json",
  ...
  "useGetDbModelQuery": "/modules/db-crud/db/ts-functions/use-get-db-model-query.json",
  "useModelQuery": "/modules/db-crud/db/ts-functions/use-model-query.json",
