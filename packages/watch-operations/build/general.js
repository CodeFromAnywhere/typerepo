...
var gitCommitAllCron=function(){setInterval((function(){try{
// NB: This doesn't work well with nested .git folders!
(0,child_process_1.execSync)("[[ `git status --porcelain .` ]] && git add . && git commit -m 'Automatic commit'",{cwd:(0,get_path_1.getProjectRoot)(),stdio:"inherit"})}catch(e){}}),36e5)};exports.gitCommitAllCron=gitCommitAllCron;
