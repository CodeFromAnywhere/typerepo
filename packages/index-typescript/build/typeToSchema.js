 ...
 */exports.typeToSchema=typeToSchema;var getParamSchema=function(e,t,r){var i,a,n,o;void 0===t&&(t=[]),void 0===r&&(r=void 0);var s=e.getText(),l=e.getNonNullableType(),u=l.getText(),p={};if(p.optional=u!==s,l.isArray())return(p=handleExplicitValidation("array",p,t)).type="array",p.items=(0,exports.getParamSchema)(l.getArrayElementTypeOrThrow(),[])||{},Object.keys(p.items).forEach((function(e){return delete p.items[e].optional})),delete p.items.optional,p;if("Date"===l.getText())return p.type="string",p.format="date-time",p;if((0,exports.isPrimitive)(l))return p.type=s.replace(" | undefined",""),"string"===p.type&&(p.allOf=[{transform:["trim"]},{minLength:1}]),p=handleExplicitValidation(l.getText(),p,t);if(l.isClass()||l.isInterface()){var m=l.getText().split(").")[1]||l.getText(),c=s.split('").')[0].split('import("')[1];if(c&&c.includes("/node_modules/"))return p;
// eslint-disable-next-line @typescript-eslint/no-var-requires
var d=c&&!(null==c?void 0:c.includes("/node_modules/"))?require(c)[m]:void 0;c&&!d&&console.log(m+" not found type");
...
var g=d&&// @ts-ignore
Reflect.getMetaData(exports.symbols.validations,d.prototype)||{};return p.$ref="#/definitions/"+m,definitions[m]||(definitions[m]=getObjectSchema(e,t,g)),p}if(l.isObject())return p=getObjectSchema(e,t);
// enum --------------------------------------
if(l.isEnumLiteral()&&r){m=r.getName();var f=null===(a=null===(i=null==r?void 0:r.getValueDeclarationOrThrow())||void 0===i?void 0:i.getSourceFile().getEnum((function(e){return e.getName()===l.getText()})))||void 0===a?void 0:a.getMembers();return(v={}).enum=null==f?void 0:f.map((function(e){return e.getName()})),v["x-enumNames"]=null==f?void 0:f.map((function(e){return e.getValue()})),v.type=(null===(n=v.enum)||void 0===n?void 0:n[0])?typeof(null===(o=v.enum)||void 0===o?void 0:o[0]):void 0,definitions[m]=v,p.$ref="#/definitions/"+m,p}if(l.isEnum()){var v;m=(0,lodash_1.last)(l.getText().split("."));return(v={}).enum=l.getUnionTypes().map((function(e){return e.getLiteralValueOrThrow()})),v["x-enumNames"]=l.getUnionTypes().map((function(e){return(0,lodash_1.last)(e.getText().split("."))})),v.type=typeof v.enum[0],definitions[m]=v,p.$ref="#/definitions/"+m,p}var h=e.getUnionTypes().filter((function(e){return!e.isUndefined()}));return h.length>1?(p.oneOf=h.map((function(e){return(0,exports.getParamSchema)(e,t)})),p.oneOf[0]||(delete p.oneOf,p.enum=h.map((function(e){return e.getText().slice(1,-1)})),p["x-enumNames"]=h.map((function(e){return e.getText().slice(1,-1)})),p.type=typeof p.enum[0]),p):void 0};exports.getParamSchema=getParamSchema;
