...
// skipTypeCheck: true,
path:e,tsconfig:a,type:"*"},s=(0,exports.tryCreateSchema)(i),c=s.schema,u=s.error,c&&c.definitions?[3/*break*/,4]:(l="No schema/definitions found for ".concat(e,". Error: ").concat(u),(0,log_1.log)(l,{type:"debug"}),[4/*yield*/,(0,operation_util_1.writeKeyToOperationIndexJson)(e,"indexInteracesErrors",[l])]);case 4:return f=Object.keys(c.definitions).map((function(n){var o=t.find((function(e){return e.name===n})),a=!!o,i=r.includes(n),s=n.startsWith("NamedParameters");if(a||i||s)return(0,schemaToTsInterface_1.schemaToTsInterface)(e,n,c,o);
